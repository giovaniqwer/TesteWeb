...
<html lang=pt-br">
    ...
    <head>
		...
		$(function(){
			$("body").on("click", ".calendariofundacao", function(){
			if (!$(this).hasClass("hasDatepicker"))
			{
				$(this).datepicker({
					showButtonPanel: true,
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<div class="conteudo">
	<body>
		<form method="post" name="formAltera" action="edit2.php" enctype="multipart/form-data">
			<h1>Edição de dados - Fornecedor </h1>
			<table width="50%" align="center">
				...
				<tr>
					...
					<td><input type="text" name="dataFund" class="calendariofundacao" value="<?php echo $dataOK?>"/></td>
				</tr>
				<tr>
