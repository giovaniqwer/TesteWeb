		...
		<table width = "85%" border="1" align="center">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="form-edit2.php?id=<?php echo $fornecedor['idFornecedor']?>"> Editar </a><a href="delete2.php?id=<?php echo  $fornecedor['idFornecedor'] ?>" onclick="return  confirm('Tem certeza que deseja  excluir?');"> Excluir </a></td>
				</tr>
				<?php endwhile; ?>
			</tbody>
		</table>
